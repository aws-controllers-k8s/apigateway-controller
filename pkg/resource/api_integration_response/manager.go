...
// +kubebuilder:rbac:groups=apigateway.services.k8s.aws,resources=apiintegrationresponses,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.services.k8s.aws,resources=apiintegrationresponses/status,verbs=get;update;patch
