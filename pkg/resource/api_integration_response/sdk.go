...
var (
	...
	_ = strings.ToLower("")
	_ = &svcsdk.Client{}
	_ = &svcapitypes.APIIntegrationResponse{}
...
func (rm *resourceManager) sdkCreate(
	...
	var resp *svcsdk.PutIntegrationResponseOutput
	_ = resp
	resp, err = rm.sdkapi.PutIntegrationResponse(ctx, input)
	rm.metrics.RecordAPICall("CREATE", "PutIntegrationResponse", err)
	if err != nil {
		return nil, err
	}
	// Merge in the information we read from the API call above to the copy of
...
func (rm *resourceManager) newCreateRequestPayload(
	ctx context.Context,
	r *resource,
) (*svcsdk.PutIntegrationResponseInput, error) {
	...
	if r.ko.Spec.ResponseParameters != nil {
		res.ResponseParameters = aws.ToStringMap(r.ko.Spec.ResponseParameters)
	}
	if r.ko.Spec.ResponseTemplates != nil {
		res.ResponseTemplates = aws.ToStringMap(r.ko.Spec.ResponseTemplates)
	}
	if r.ko.Spec.RestAPIID != nil {
		res.RestApiId = r.ko.Spec.RestAPIID
	}
	if r.ko.Spec.SelectionPattern != nil {
		res.SelectionPattern = r.ko.Spec.SelectionPattern
	}
	if r.ko.Spec.StatusCode != nil {
		res.StatusCode = r.ko.Spec.StatusCode
	}
...
func (rm *resourceManager) setStatusDefaults(
	ko *svcapitypes.APIIntegrationResponse,
) {
