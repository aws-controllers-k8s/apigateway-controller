...
// +kubebuilder:rbac:groups=apigateway.services.k8s.aws,resources=apikeys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.services.k8s.aws,resources=apikeys/status,verbs=get;update;patch
