...
// +kubebuilder:rbac:groups=apigateway.services.k8s.aws,resources=authorizers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.services.k8s.aws,resources=authorizers/status,verbs=get;update;patch
