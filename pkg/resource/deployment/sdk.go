...
func (rm *resourceManager) sdkFind(
	...
	if resp.ApiSummary != nil {
		...
		ko.Status.APISummary = f0
	} else {
		ko.Status.APISummary = nil
	}
...
func (rm *resourceManager) newDescribeRequestPayload(
	...
	if r.ko.Status.ID != nil {
		res.DeploymentId = r.ko.Status.ID
	}
...
func (rm *resourceManager) newCreateRequestPayload(
	...
	if r.ko.Spec.CanarySettings != nil {
		f2 := &svcsdktypes.DeploymentCanarySettings{}
	...
	if r.ko.Spec.StageDescription != nil {
		res.StageDescription = r.ko.Spec.StageDescription
	}
