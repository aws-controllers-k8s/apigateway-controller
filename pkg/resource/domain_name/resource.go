...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	f1, f1ok := identifier.AdditionalKeys["domainNameID"]
	if f1ok {
		r.ko.Status.DomainNameID = aws.String(f1)
	}
