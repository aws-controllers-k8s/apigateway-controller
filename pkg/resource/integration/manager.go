...
// +kubebuilder:rbac:groups=apigateway.services.k8s.aws,resources=integrations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.services.k8s.aws,resources=integrations/status,verbs=get;update;patch
