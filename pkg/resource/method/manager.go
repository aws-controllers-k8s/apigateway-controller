...
// +kubebuilder:rbac:groups=apigateway.services.k8s.aws,resources=methods,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.services.k8s.aws,resources=methods/status,verbs=get;update;patch
