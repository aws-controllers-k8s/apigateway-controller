...
// +kubebuilder:rbac:groups=apigateway.services.k8s.aws,resources=resources,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.services.k8s.aws,resources=resources/status,verbs=get;update;patch
