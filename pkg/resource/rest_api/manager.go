...
// +kubebuilder:rbac:groups=apigateway.services.k8s.aws,resources=restapis,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.services.k8s.aws,resources=restapis/status,verbs=get;update;patch
